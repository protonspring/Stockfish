...
constexpr Score PBonus[RANK_NB][FILE_NB] =
  { // Pawn (asymmetric distribution)
   ...
   { S( -8,  9), S( -7,  9), S( -8, -2), S(  6,-12), S(  6,-12), S( -8, -2), S( -7,  9), S( -8,  9) },
   { S(-11,  5), S(-13, 13), S( -6, 14), S(  7, 29), S(  7, 29), S( -6, 14), S(-13, 13), S(-11,  5) },
   { S( -7,  4), S(  0, 15), S(-10, 15), S( -5, 23), S( -5, 23), S(-10, 15), S(  0, 15), S( -7,  4) }
  };
