...
constexpr Score PBonus[RANK_NB][FILE_NB] =
  { // Pawn
   ...
   { S( -4, -1), S(  4,  4), S( 13,  4), S( 16,-11), S( 16,-11), S( 13,  4), S(  4,  4), S( -4, -1) },
   { S(-10, -1), S(  0,  0), S( 29,  3), S( 25,-11), S( 25,-11), S( 29,  3), S(  0,  0), S(-10, -1) },
   { S(-14, -2), S( -5,  0), S( 19,  4), S( 30, -6), S( 30, -6), S( 19,  4), S( -5,  0), S(-14, -2) },
   { S( -5, 13), S( -5,  4), S( -2,  5), S(  8,  0), S(  8,  0), S( -2,  5), S( -5,  4), S( -5, 13) },
   { S(-16, 15), S(-10,  6), S( -2,  6), S( -7, 15), S( -7, 15), S( -2,  6), S(-10,  6), S(-16, 15) },
   { S( -8,  4), S( -8,  8), S( -8, 11), S( -7, 21), S( -7, 21), S( -8, 11), S( -8,  8), S( -8,  4) }
  };
