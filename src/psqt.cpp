...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S(-10,10), S( -2, 10), S( -1,-1), S(12,-8) },
   { S(-11,16), S(-12,  6), S( -2, 8), S( 4,16) },
   { S(-10,10), S(-10, 20), S(-10,15), S(-2,25) }
  },
  { // Knight
  ...
  { // Rook
   { S(-24, 0), S(-15, 0), S( -8, 0), S( 0, 0) },
   { S(-18, 0), S( -5, 0), S( -1, 0), S( 1, 0) },
   { S(-19, 0), S(-10, 0), S(  1, 0), S( 0, 0) },
   { S(-21, 0), S( -7, 0), S( -4, 0), S(-4, 0) },
   { S(-21, 0), S(-12, 0), S( -1, 0), S( 4, 0) },
   { S(-23, 0), S(-10, 0), S(  1, 0), S( 6, 0) },
   { S(-11, 0), S(  8, 0), S(  9, 0), S(12, 0) },
   { S(-25, 0), S(-18, 0), S(-11, 0), S( 2, 0) }
  },
  { // Queen
