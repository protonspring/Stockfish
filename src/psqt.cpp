...
constexpr Score PBonus[RANK_NB][FILE_NB] =
  { // Pawn
   ...
   { S(  0,-11), S( -3, -4), S( 13, -1), S( 19, -4), S( 16,  0), S( 13,  7), S(  4,  4), S( -4,-13) },
   { S(-16, -8), S(-12,  6), S( 20, -3), S( 21,  0), S( 25, -5), S( 29,  3), S(  0,  0), S(-17,-11) },
   { S(-14,  3), S(-17,  6), S( 11,-10), S( 21,  1), S( 32, -6), S(  9, -1), S( -5,  0), S(-14, -2) },
   { S(  4, 13), S(  6,  7), S(  2, -7), S(  3, -5), S( -2, -5), S( -2, -1), S( -9,  0), S( -5, 13) },
   { S( -5, 15), S( -9, 10), S(  7, 16), S(  8, 12), S( -7, 21), S( -2,  3), S(-10, -4), S(-16, 15) },
   { S(-10,  6), S( -8,  6), S( -7, 16), S(-12, 27), S( -7, 15), S( -8, 11), S( -8,  6), S( -8,  4) }
  };
