...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S( -2,-12), S(  1, -1), S( 13,  0), S( 17,  6) },
   { S(-13, -4), S( -6,  2), S( 24,  0), S( 23, -5) },
   { S(-12,  1), S(-11, -4), S( 15, -8), S( 26, -3) },
   { S(-10, 13), S(-10,  6), S( -5,  1), S(  6,  5) },
   { S(-11, 14), S( -9, 10), S( -8, 10), S(  1, 17) },
   { S( -9, 15), S(-10, 10), S( -8, 14), S(-10, 21) }
  },
  { // Knight
