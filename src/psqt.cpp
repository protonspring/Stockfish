...
Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S(-10,-5), S(  7, -1), S(  7, 2), S(17, 2) },
   { S(-10,-2), S(  2,  2), S( 23, 2), S(23, 2) },
   { S(-10, 3), S(  0,  4), S( 20, 4), S(24, 2) },
   { S(-10, 5), S( -2,  5), S(  6, 5), S(12, 6) },
   { S(-10, 7), S( -8,  8), S( -2,10), S( 4,16) },
   { S(-10, 9), S(-10, 11), S(-10,14), S(-2,25) }
  },
  { // Knight
