...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S(-11, 0), S(  7,  0), S(  7, 0), S(17, 0) },
   { S(-16, 0), S( -3,  0), S( 23, 0), S(23, 0) },
   { S(-14, 0), S( -7,  0), S( 20, 0), S(24, 0) },
   { S(-11, 0), S( -2,  0), S( -1, 0), S(12, 0) },
   { S(-11, 0), S(-10,  0), S( -2, 0), S( 4, 0) },
   { S(-11, 0), S(-10,  0), S(-10, 0), S(-2, 0) }
  },
  { // Knight
