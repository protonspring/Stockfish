...
Value16 PieceValue[PHASE_NB][PIECE_NB] = {
  { VALUE_ZERO16, PawnValueMg, KnightValueMg, BishopValueMg, RookValueMg, QueenValueMg },
  { VALUE_ZERO16, PawnValueEg, KnightValueEg, BishopValueEg, RookValueEg, QueenValueEg }
};
