...
moves_loop: // When in check, search starts from here
    ...
    MovePicker mp(pos, ttMove, depth, &thisThread->mainHistory, &thisThread->captureHistory, contHist, countermove, ss->killers, SQ_NONE);
  ...
  Value qsearch(Position& pos, Stack* ss, Value alpha, Value beta, Depth depth) {
    ...
    // be generated.
    MovePicker mp(pos, ttMove, depth, &pos.this_thread()->mainHistory, &pos.this_thread()->captureHistory, NULL, MOVE_NONE, NULL, to_sq((ss-1)->currentMove));
