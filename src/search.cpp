...
void Thread::search() {
  ...
  contempt = (us == WHITE ?  make_score<SCORE_FULL>(ct, ct / 2)
                          : -make_score<SCORE_FULL>(ct, ct / 2));
         ...
         && !(Limits.depth && mainThread && rootDepth / ONE_PLY > Limits.depth))
  {
      ...
      for (pvIdx = 0; pvIdx < multiPV && !Threads.stop; ++pvIdx)
      {
          ...
          if (rootDepth >= 5 * ONE_PLY)
          {
              ...
              contempt = (us == WHITE ?  make_score<SCORE_FULL>(dct, dct / 2)
                                      : -make_score<SCORE_FULL>(dct, dct / 2));
          }
