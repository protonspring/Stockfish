...
Score Entry::do_king_safety(const Position& pos) {
  ...
  int kingPawnDistance = 0;

  //rough distance to any first of our pawns
  if (pos.pieces(Us, PAWN))
      kingPawnDistance = distance(ksq,*pos.squares<PAWN>(Us));
  ...
  return make_score(bonus, -16 * kingPawnDistance);
}
