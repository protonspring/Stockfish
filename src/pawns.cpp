...
namespace {
  ...
  constexpr Value ShelterStrength[int(FILE_NB) / 2][RANK_NB] = {
    { V(-13), V(56), V( 64), V( 18), V(-13), V( 10), V(-39) },
  ...
  constexpr Value UnBlocked[4][RANK_NB] =
    { { V( 3), V(140), V( 87), V( 31), V(  7), V(-20), V(-20) },
      { V( 3), V(140), V(131), V(  8), V( 25), V(  0), V(  0) },
      { V( 3), V(140), V(118), V( 56), V( 27), V(  0), V(  0) },
      { V( 3), V(140), V(110), V( 55), V( 26), V(  0), V(  0) } };
