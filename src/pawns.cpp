...
namespace {
  ...
  constexpr Value ShelterStrength[int(FILE_NB) / 2][RANK_NB] = {
    ...
    { V(-13), V(83+10), V( 42+10), V(-27+10), V(  2+10), V(-32+10), V(-45+10) },
    { V(-26), V(63+20), V(  5+20), V(-44+20), V( -5+20), V(  2+20), V(-59+20) },
    { V(-19), V(53+30), V(-11+30), V(-22+30), V(-12+30), V(-51+30), V(-60+30) }
  };
  ...
  constexpr Value UnblockedStorm[int(FILE_NB) / 2][RANK_NB] = {
    ...
    { V(  5), V( 35+10), V(121+10), V( -2+10), V( 15+10), V(0), V(0) },
    { V(-20), V( 22+20), V( 98+20), V( 36+20), V(  7+20), V(0), V(0) },
    { V(-27), V( 24+30), V( 80+30), V( 25+30), V( -4+30), V(0), V(0) }
  };
