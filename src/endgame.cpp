...
ScaleFactor Endgame<KRPKR>::operator()(const Position& pos) const {
  ...
  if (   r == RANK_6
      ...
      && (rank_of(brsq) == RANK_1 || (!tempo && distance(file_of(brsq), file_of(wpsq)) >= 3)))
      return SCALE_FACTOR_DRAW;
  ...
  if (r <= RANK_4 && bksq > wpsq)
  {
      ...
      if (   distance(file_of(bksq), file_of(wpsq)) == 1
...
ScaleFactor Endgame<KRPKB>::operator()(const Position& pos) const {
  ...
  if (pos.pieces(PAWN) & (FileABB | FileHBB))
  {
      ...
      if (   rk == RANK_6
          ...
          && distance(file_of(bsq), file_of(psq)) >= 2)
...
ScaleFactor Endgame<KRPPKRP>::operator()(const Position& pos) const {
  ...
  if (   distance(file_of(bksq), file_of(wpsq1)) <= 1
      && distance(file_of(bksq), file_of(wpsq2)) <= 1
...
ScaleFactor Endgame<KBPPKB>::operator()(const Position& pos) const {
  ...
  switch (distance(file_of(psq1), file_of(psq2)))
  {
  case 0:
  ...
  case 1:
    ...
    if (   ksq == blockSq1
        ...
        && (   bbsq == blockSq2
            ...
            || distance(rank_of(psq1), rank_of(psq2)) >= 2))
        return SCALE_FACTOR_DRAW;
