...
const Bitboard FileBB[FILE_NB] = {FileABB,FileBBB,FileCBB,FileDBB,FileEBB,FileFBB,FileGBB,FileHBB};
...
const Bitboard RankBB[RANK_NB] = {Rank1BB,Rank2BB,Rank3BB,Rank4BB,Rank5BB,Rank6BB,Rank7BB,Rank8BB};
