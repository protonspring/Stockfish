...
const Bitboard OutpostSquares[COLOR_NB] = {
    (FileCBB | FileDBB | FileEBB | FileFBB) & (Rank4BB | Rank5BB | Rank6BB), //WHITE
    (FileCBB | FileDBB | FileEBB | FileFBB) & (Rank5BB | Rank4BB | Rank3BB)  //BLACK
};
