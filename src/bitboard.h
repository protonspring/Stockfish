...
template<Color C> inline Square frontmost_sq(Bitboard b) { return C == WHITE ? msb(b) : lsb(b); }
template<Color C> inline Square backmost_sq(Bitboard b) { return C == WHITE ? lsb(b) : msb(b); }
