...
constexpr Bitboard ColorSquares[SQUARE_COLOR_NB] = {0xAA55AA55AA55AA55ULL, 0x55AA55AA55AA55AAULL }; //Dark, Light
...
constexpr SquareColor square_color(Square s) {
  return SquareColor((s + rank_of(s)) & 1);
}
