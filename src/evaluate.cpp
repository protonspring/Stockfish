...
namespace {
  ...
  constexpr Value LazyThreshold  = Value(1700);
...
#undef S
  ...
  Value Evaluation<T>::value() {
    ...
    int egscale = (17000 - pos.non_pawn_material()) / 128;
    int mgscale = 100 - egscale;
    Value v = mgscale * mg_value(score) / 128 + egscale * eg_value(score) / 128;
