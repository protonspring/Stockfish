...
namespace {
  ...
  constexpr int KingAttackWeights[PIECE_TYPE_NB] = { 0, 0, 7*81/8, 7*52/8, 7*44/8, 7*10/8 };
...
#undef S
  ...
  void Evaluation<T>::initialize() {
    ...
    kingRing[Us] = shift<NORTH>(attackedBy[Us][KING]) |
                   shift< EAST>(attackedBy[Us][KING]) |
                   shift<SOUTH>(attackedBy[Us][KING]) |
                   shift< WEST>(attackedBy[Us][KING]) ;
