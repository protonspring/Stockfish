...
void Position::set_check_info(StateInfo* si) const {
  ...
  si->blockersForKing[WHITE] = slider_blockers(pieces(BLACK), square<KING>(WHITE), si->pinners[BLACK], false);
  si->blockersForKing[BLACK] = slider_blockers(pieces(WHITE), square<KING>(BLACK), si->pinners[WHITE], false);
...
Bitboard Position::slider_blockers(Bitboard sliders, Square s, Bitboard& pinners, bool quitEarly) const {
