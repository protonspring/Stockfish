...
void Position::set_check_info(StateInfo* si) const {
  ...
  si->blockersForKing[WHITE] = slider_blockers(square<KING>(WHITE), si->pinners[BLACK]);
  si->blockersForKing[BLACK] = slider_blockers(square<KING>(BLACK), si->pinners[WHITE]);
...
Bitboard Position::slider_blockers(Square s, Bitboard& pinners) const {
